Other requirements you must do for this assignment:

* Program must remain modularized (you are to resubmit all three code files)
* Create a UML diagram for the class(s)
* Class attributes MUST be protected
