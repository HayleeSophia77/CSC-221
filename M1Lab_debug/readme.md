...
* Tell the user if their answer was correct or not .
* The program is to give the user 10 points for each correct answer . So if all 10 question were answered right, the user's score should be 100
