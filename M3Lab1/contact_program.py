    ...
    while choice != "4": # not exit
            ...
            if choice == "1": # display instances
                ...
                for cus_num in range(1, num + 1):
                    ...
                    phone = input(f"What is {first} {last}'s phone number? ")
                    address = input(f"Enter {first} {last}'s address? ")
                    state = input(f"In what state does {first} {last} live? ")
                    email = input(f"What is {first} {last}'s email address? ")
                    # create instance 
                ...
                customer = fn.cus_update(last, customers)
